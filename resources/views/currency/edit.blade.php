            ...
            <div class="col-md-5">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sửa tỷ giá</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('admin/currency/edit/'.$tygia->id) }}" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="box-body">
                            <div class="form-group">
                                <label for="title">Tên tỷ giá</label>
                                <input type="text" name="name" class="form-control" id="name" value="{{$tygia->name}}">
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="code" class="form-control" id="code" value="{{$tygia->code}}">
                            </div>
                            <div class="form-group">
                                <label for="title">Tỷ giá</label>
                                <input type="number" name="value" class="form-control" id="value" value="{{$tygia->value}}">
                            </div>
                            <!-- /.box-body -->
