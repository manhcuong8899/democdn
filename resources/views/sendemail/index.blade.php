        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('admin/sendemails/create/'.$type->code) }}" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="box-body">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="formsend" id="formsend">
                                        <option value="0">Lựa chọn hình thức gửi</option>
                            ...
                            <div class="col-md-12" align="center">
                                <button type="submit" class="btn btn-primary" id="submit" style="display: none">Thêm mới</button>
                            </div>
                        </div>
                    </form>
                </div>
