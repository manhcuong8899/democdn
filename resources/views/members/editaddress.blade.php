...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('admin/members/address/update/'.$diachi->id) }}" method="POST" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="receiver_user" class="form-control" id="receiver_user" value="{{$diachi->receiver_user}}">
                        </div>
                        <div class="form-group">
                            <label for="title">Điện thoại nhận hàng</label>
                            <input type="text" name="phone" class="form-control" id="phone" value="{{$diachi->phone}}">
                        </div>
                        <div class="form-group">
                            <label for="title">Địa chỉ giao hàng</label>
                            <input type="text" name="address" class="form-control" id="address" value="{{$diachi->address}}">
                        </div>
                        <div class="form-group">
                            <label for="title">Tỉnh/Thành phố</label>
                            <select class="form-control" name="city" id="city">
                                <option value="{{$diachi->city}}">{{$diachi->cates->name}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="is_primary" id="is_primary">
                                <option value="{{$diachi->is_primary}}">@if($diachi->is_primary==1) Chính thức @else Dự phòng  @endif</option>
