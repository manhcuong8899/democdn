    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Sửa tiêu điểm</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('admin/tips/edit/'.$tip->id) }}" method="POST" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="box-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="title">Tiêu đề</label>
                            <input type="text" name="name" class="form-control" id="name" value="{{$tip->name}}">
                        </div>

                        <div class="form-group">
                            <img src="{{asset('public/images/tips/'.$tip->images)}}" width="120">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group {{ $errors->has('short') ? ' has-error' : ' has-feedback' }}">
                            ...
                            <textarea class="form-control" id="short" type="text" name="short" rows="5"/>{{$tip->short}}</textarea>
                            @if ($errors->has('short'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="url" class="form-control" id="url" value="{{$tip->url}}">
                        </div>
                        <div class="form-group">
                            <label for="title">Thứ tự</label>
                            <input type="text" name="order" class="form-control" id="order" value="{{$tip->order}}">
                        </div>
                        <!-- /.box-body -->
