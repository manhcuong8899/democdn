...
@section('content')
    ...
    <section class="content-header">
        <h1>Gửi khiếu nại đơn hàng: {{$package->code}}</h1>
    </section>
        <section class="content">
                <div class="box box-primary">
                    <div class="box-header with-bpackage">
                        <h3 class="box-title">Gửi khiếu nại đơn hàng: {{$package->code}}</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('package/complaints/'.$package->id) }}" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="box-body">
                        <div class="box-body">
