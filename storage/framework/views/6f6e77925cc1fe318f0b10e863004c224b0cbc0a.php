<!-- SCRIPTS -->
<script src="<?php echo e(asset('themes/assets/js/jquery-1.11.3.min.js')); ?>"></script>
<script src="<?php echo e(asset('themes/assets/bootstrap/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('themes/assets/js/webslidemenu.js')); ?>"></script>
...
<script>
    $('#submitregister').click(function() {
        ...
        $.ajax({
            url: '<?php echo e(url('member/register')); ?>',
            dataType: "json",
            type: "post",
            data: {_method: 'post', _token: '<?php echo e(csrf_token()); ?>',email:email,password:password,full_name:full_name,phone:phone,city:city,address:address,confirmpassword:confirmpassword}
        }).done(function (data){
          if(data.check==false){
