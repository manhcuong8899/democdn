                        ...
                        <div class="col-sm-5">
                            <div class="minicart_summery">
                                ...
                                <div class="summary_row summary_btnshowcart">
                                    <a class="summary_btn btn-black" href="<?php echo e(url('cart')); ?>">Xem giỏ hàng</a>
                                    <a class="summary_btn" href="<?php echo e(url('checkout')); ?>">Thanh Toán</a>
                                </div>
                            </div>
                        </div><!--col-sm-6 -->
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="box-hide box-forgot">
                    ...
                    <form class="login-form" role="form" method="POST" action="<?php echo e(url('member/forgotpassword')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="box-register">
                    <form class="login-form" method="POST" action="<?php echo e(url('member/register')); ?>" id="idFormregister">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row-input text-center">
                            <p class="sm2-padding">Bằng việc đăng ký tài khoản, bạn đã đồng ý với <a href="<?php echo e(url('dieukhoansudung.html')); ?>" TARGET="_blank"> <span style="text-decoration: underline;">điều kiện sử dụng BF365.vn</span></a></p>
                        </div>
...
<div class="modal fade" id="myModalChangepass" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="login-form" role="form" method="POST" action="<?php echo e(url('member/changepass')); ?>">
                    <?php echo csrf_field(); ?>
