...
class PermissionsController extends Controller
{
    ...
    public function updateSinglePermission(UpdateSinglePermissionRequest $request, $permissionId)
    {
        ...
        if (is_null($permission)) {
            Flash::info(trans('VNPCMS.messages.models.notfound', ['modelname' => trans('VNPCMS.models.permission')]));
        ...
        Flash::success(trans('VNPCMS.messages.models.update.success', ['modelname' => trans('VNPCMS.models.permission')]));
    ...
    public function update(Request $request)
    {
        ...
        if (is_null($requestRoles)) {
            ...
            Flash::success(trans('VNPCMS.messages.models.update.success', ['modelname' => trans('VNPCMS.models.permissions')]));
